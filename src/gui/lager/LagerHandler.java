...
public class LagerHandler {
    ...
    public void opretLagerActionHandler(LagerForm form) {
        ...
        if(lagerNavn.isEmpty()) {
            ...
            form.clearAction();
            Alert alert = new Alert(Alert.AlertType.INFORMATION, lager.getNavn() + " er blevet oprettet");
            alert.setHeaderText(null);
            alert.showAndWait();
        }
    }
    ...
    public void opretReolHandler(LagerForm form) {
        ...
        if(lager == null) {
            ...
            form.clearAction();
            Alert alert = new Alert(Alert.AlertType.INFORMATION, "reol " + reol.getReolNummer() + " er blevet oprettet");
            alert.setHeaderText(null);
            alert.showAndWait();
        }
    }
